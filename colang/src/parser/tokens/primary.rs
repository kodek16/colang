    ...
    fn rules() -> Vec<(Regex, Box<dyn Sync + Fn(&str) -> PrimaryTokenPayload>)> {
        vec![
            ...
            (
                ...
                Box::new(|_| PrimaryTokenPayload::KwWrite),
            ),
            (
                Regex::new(r"^writeln\b").unwrap(),
                Box::new(|_| PrimaryTokenPayload::KwWriteLn),
            ),
            (
            ...
            (
                Regex::new(r"^==").unwrap(),
                Box::new(|_| PrimaryTokenPayload::DoubleEqual),
            ),
            (
                Regex::new(r"^=").unwrap(),
                Box::new(|_| PrimaryTokenPayload::SingleEqual),
            ),
            (
                Regex::new(r"^!=").unwrap(),
                Box::new(|_| PrimaryTokenPayload::NotEqual),
            ),
            (
                Regex::new(r"^<=").unwrap(),
